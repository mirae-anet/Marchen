...
public class TPSCharacterController : MonoBehaviour
{
    ...
    private void Move()
    {
        if (!BoxManPlayerMain.isDead)
        {
            ...
            if (isMove && !BoxManPlayerMain.isJumping)
            {
    ...
    private void Jump()
    {
        ...
        {
            if (!BoxManPlayerMain.isJumping) // 점프 상태가 아닐 시
            {
                BoxManPlayerMain.isJumping = true;
    ...
    void Update()
    {
        ...
        if (BoxManPlayerMain.isDead == true)
        {
            Dead();
        }
    }
